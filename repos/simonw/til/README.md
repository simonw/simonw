...
* [Building and deploying a custom site using GitHub Actions and GitHub Pages](https://github.com/simonw/til/blob/main/github-actions/github-pages.md) - 2025-03-18
* [Using uvx in GitHub Actions in a cache-friendly way](https://github.com/simonw/til/blob/main/github-actions/uvx-github-actions-cache.md) - 2026-07-13
...
* [Loading SQLite extensions in Python on macOS](https://github.com/simonw/til/blob/main/sqlite/sqlite-extensions-python-macos.md) - 2023-01-07
...
* [SQLite triggers](https://github.com/simonw/til/blob/main/sqlite/sqlite-triggers.md) - 2025-05-09
...
* [Subtests in pytest 9.0.0+](https://github.com/simonw/til/blob/main/pytest/subtests.md) - 2025-12-04
...
* [Using iconv to convert the text encoding of a file](https://github.com/simonw/til/blob/main/linux/iconv.md) - 2022-06-14
...
* [Running jupyterlab via uv tool install](https://github.com/simonw/til/blob/main/jupyter/jupyterlab-uv-tool-install.md) - 2025-03-08
...
* [Viewing GeoPackage data with SpatiaLite and Datasette](https://github.com/simonw/til/blob/main/spatialite/viewing-geopackage-data-with-spatialite-and-datasette.md) - 2022-12-11
...
* [Testing Electron apps with Playwright and GitHub Actions](https://github.com/simonw/til/blob/main/electron/testing-electron-playwright.md) - 2022-07-13
...
* [Reading thermometer temperatures over time from a video](https://github.com/simonw/til/blob/main/googlecloud/video-frame-ocr.md) - 2023-04-02
...
* [Running Python code in a Pyodide sandbox via Deno](https://github.com/simonw/til/blob/main/deno/pyodide-sandbox.md) - 2023-05-10
...
* [Running LLaMA 7B and 13B on a 64GB M2 MacBook Pro with llama.cpp](https://github.com/simonw/til/blob/main/llms/llama-7b-m2.md) - 2023-03-10
...
* [Using Blender with coding agents on macOS](https://github.com/simonw/til/blob/main/llms/blender-coding-agents-macos.md) - 2026-09-05
...
* [Using uv to develop Python command-line applications](https://github.com/simonw/til/blob/main/uv/uv-cli-apps.md) - 2024-10-23
* [Running pytest against a specific Python version with uv run](https://github.com/simonw/til/blob/main/uv/pytest-uv.md) - 2025-02-04
* [Testing different Python versions with uv with-editable and uv-test](https://github.com/simonw/til/blob/main/uv/uv-tests.md) - 2025-10-08
* [Dependency groups and uv run](https://github.com/simonw/til/blob/main/uv/dependency-groups.md) - 2025-12-02
...
* [Taking Neon I at the Crucible](https://github.com/simonw/til/blob/main/neon/neon-1.md) - 2026-01-11
<!-- index ends -->
